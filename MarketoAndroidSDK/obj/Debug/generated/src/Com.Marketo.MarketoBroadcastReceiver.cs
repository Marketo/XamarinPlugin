...
namespace Com.Marketo {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.marketo']/class[@name='MarketoBroadcastReceiver']"
	[global::Android.Runtime.Register ("com/marketo/MarketoBroadcastReceiver", DoNotGenerateAcw=true)]
	public partial class MarketoBroadcastReceiver : global::Marketo.Push.MktoWakefulBroadcastReceiver {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/marketo/MarketoBroadcastReceiver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (MarketoBroadcastReceiver); }
		}

		protected MarketoBroadcastReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.marketo']/class[@name='MarketoBroadcastReceiver']/constructor[@name='MarketoBroadcastReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
...
#pragma warning disable 0169
		...
		{
			global::Com.Marketo.MarketoBroadcastReceiver __this = global::Java.Lang.Object.GetObject<global::Com.Marketo.MarketoBroadcastReceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.marketo']/class[@name='MarketoBroadcastReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
